...
- 既存サイト: https://example-koumuten.jp
- デモURL: https://demos.example.com/minami-koumuten/
...
件名: 【みなみ工務店様】Webサイトのリニューアル案を作成しました（無料・確認用）
...
新築・リフォームを地域密着で提供という強みが初見で伝わる構成を意識しています。

▼ デモ（みなみ工務店様向け・提案用）
https://demos.example.com/minami-koumuten/
