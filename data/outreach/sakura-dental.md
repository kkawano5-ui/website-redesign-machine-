# さくら歯科クリニック 向けアウトリーチ下書き

- 既存サイト: https://example-dental.jp
- デモURL: https://demos.example.com/sakura-dental/
...
件名: 【さくら歯科クリニック様】Webサイトのリニューアル案を作成しました（無料・確認用）
...
地域密着の歯科医院という強みが初見で伝わる構成を意識しています。

▼ デモ（さくら歯科クリニック様向け・提案用）
https://demos.example.com/sakura-dental/
