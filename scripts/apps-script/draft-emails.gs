...
function buildBody_(companyName, valueProposition) {
  ...
  return [
    ...
    '',
    '突然のご連絡失礼いたします。',
    '合同会社Asante Sana / RAHA KENYAの河野と申します。',
    'ケニアを拠点に「ケニアの河野家」としてSNS発信を続けている、現役のクリエイター集団です。',
    '',
    '▼ 自社運用の主な実績（すべて広告費ゼロ）',
    ...
    '',
    '弊社の強みは、「ニッチで魅力が伝わりにくい商材」を、切り口次第で何万人もの共感に変えていく企画・編集力です。BtoB・専門商材・地方拠点・採用難ポジション──"説明動画になりがちな領域"こそ、私たちが最も力を発揮してきた場所です。',
    '',
    valueProposition,
    '',
    'サービス内容・料金プラン（月35万円〜）・導入フローを添付資料にまとめております。ご興味ございましたら、30分ほどのオンラインミーティングで、貴社に合わせた具体的な切り口をご提案させていただきたく存じます。',
    '',
    '▼ 日程調整（Spir）',
    spirLine,
    '',
